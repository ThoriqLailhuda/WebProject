        ...
        <div class="card-body">
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td><a href="{{url('edit_ref_poli_bagian', $item->id)}}"><i class="fas fa-edit"></i></a>
                     | <a href="{{url('delete_ref_poli_bagian', $item->id)}}"><i class="fas fa-trash" style="color:red"></i></a></td>
                </tr>
                @endforeach
            </table>
